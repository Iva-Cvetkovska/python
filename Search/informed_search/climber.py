...
class Climber(Problem):
    ...
    def successor(self, state):
        ...
        # Stop
        successors['Stop'] = ((human_x, human_y), (new_house_x, house_y), new_house_dir)

        # Up 1
        new_y = human_y + 1
        if self.is_valid(human_x, new_y) or (human_x, new_y) == (new_house_x, house_y):
            successors['Up 1'] = ((human_x, new_y), (new_house_x, house_y), new_house_dir)

        # Up 2
        new_y = human_y + 2
        if self.is_valid(human_x, new_y) or (human_x, new_y) == (new_house_x, house_y):
            successors['Up 2'] = ((human_x, new_y), (new_house_x, house_y), new_house_dir)

        # Up-right 1
        new_x, new_y = human_x + 1, human_y + 1
        if self.is_valid(new_x, new_y) or (new_x, new_y) == (new_house_x, house_y):
            successors['Up-right 1'] = ((new_x, new_y), (new_house_x, house_y), new_house_dir)

        # Up-right 2
        new_x, new_y = human_x + 2, human_y + 2
        if self.is_valid(new_x, new_y) or (new_x, new_y) == (new_house_x, house_y):
            successors['Up-right 2'] = ((new_x, new_y), (new_house_x, house_y), new_house_dir)

        # Up-left 1
        new_x, new_y = human_x - 1, human_y + 1
        if self.is_valid(new_x, new_y) or (new_x, new_y) == (new_house_x, house_y):
            successors['Up-left 1'] = ((new_x, new_y), (new_house_x, house_y), new_house_dir)

        # Up-left 2
        new_x, new_y = human_x - 2, human_y + 2
        if self.is_valid(new_x, new_y) or (new_x, new_y) == (new_house_x, house_y):
            successors['Up-left 2'] = ((new_x, new_y), (new_house_x, house_y), new_house_dir)
